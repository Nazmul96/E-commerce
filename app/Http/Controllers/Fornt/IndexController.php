...
class IndexController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.index',compact('category','banner_product','feature_product','popular_product','trendy_product','home_category','brand','random_product','todaydeal','website_review'));
    }

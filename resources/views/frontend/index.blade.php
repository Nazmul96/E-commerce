               ...
               @foreach($brand as $brands_new) 
                <div class="col-lg-1 col-md-6 char_col" style="border:1px solid grey; padding:5px;">
                    <div class="brands_item">
                       <a href="{{route('brandwise.product',$brands_new->id)}}" title="{{ $brands_new->brand_name }}"> 
					...
					<div class="deals">
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
							   @foreach($todaydeal as $todaydeals) 
								<!-- Deals Item -->
								<div class="owl-item deals_item">
									<div class="deals_image"><img src="{{ asset('public/files/product/'.$todaydeals->thumbnail) }}" alt="{{ $todaydeals->name }}"></div>
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_category"><a href="#">{{ $todaydeals->subcategory->subcategory_name }}</a></div>
										  <div class="deals_item_price_a ml-auto">  @if($todaydeals->discount_price==NULL)
												<div class="deals_item_price_a ml-auto">{{ $setting->currency }}{{ $row->selling_price }}</div>
											@else
												<div class="deals_item_price_a ml-auto">{{ $setting->currency }} {{ $todaydeals->discount_price }}</div>
											@endif
										  </div>
										</div>
										<div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">
                                               <a href="{{ route('product_details',$todaydeals->slug) }}">
                                                    {{ $todaydeals->name }}
                                               </a>
											</div>
                                        </div>
                            ...
                            <!-- Popular Categories Item -->
								<div class="owl-item">
									<div class="popular_category d-flex flex-column align-items-center justify-content-center">
										...
										<a href="{{route('categorywise.product',$categories_data->id)}}">  {{ $categories_data->category_name }} </a>
										</div>
									</div>
								</div>
                           @endforeach 
